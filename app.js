...
server.get('/georeport/get', function (req, res, next) {
	if(longitude && latitude) {
		fetchUrl("http://restapi.amap.com/v3/direction/driving?output=json&origin="+longitude+","+latitude+"&destination=121.264168,31.002682&output=xml&key=10d7b58e081067d38c01996686245507", function(error, meta, body){
